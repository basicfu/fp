...
func TestAdminAPIRequiresAuth(t *testing.T) {
	...
	routes := []struct{ method, path string }{
		...
		{http.MethodGet, "/admin/api/applications/" + someUUID + "/config"},
		{http.MethodPut, "/admin/api/applications/" + someUUID + "/config"},
		{http.MethodGet, "/admin/api/applications/" + someUUID + "/config/versions"},
		{http.MethodGet, "/admin/api/applications/" + someUUID + "/config/versions/1"},
		{http.MethodPost, "/admin/api/applications/" + someUUID + "/config/rollback"},
