				...
				<Popover
					...
					<PopoverTrigger asChild>
						<Button
							...
							className={cn(
								"flex p-1 rounded-md border border-input min-h-10 h-auto items-center justify-between bg-transparent hover:bg-transparent [&_svg]:pointer-events-auto",
